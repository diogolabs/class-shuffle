...
function distribuirEmSalas(grupos, numSalas, numFileiras, numCarteiras, especiais) {
    ...
    grupos.forEach((grupo, index) => {
        ...
        if (fileira < numFileiras) {
            // CORREÇÃO: Compara diretamente a referência na memória, sem tentar formatar como texto
...
function processarCSV(event) {
    ...
    reader.onload = function(e) {
        ...
        document.getElementById('alunos').value = resultado.trim();
